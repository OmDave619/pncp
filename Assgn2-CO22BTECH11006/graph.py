...
files = ["chunk-omp", "mixed-omp", "dynamic-omp","mixedchunk-omp", "chunk",  "mixed", "dynamic","mixedchunk"]
file_map = ["Chunk - OpenMP", "Mixed - OpenMP", "Dynamic - OpenMP","MixedChunk - OpenMP", "Chunk - PThreads", "Mixed - PThreads", "Dynamic - PThreads", "MixedChunk - PThreads"]
data = True
import json
...
def plot_graph4():
    ...
    files = ['dynamic-omp', 'mixedchunk-omp', 'dynamic','mixedchunk']
    new_file_map = ['Dynamic - OpenMP','MixedChunk - OpenMP', 'Dynamic - PThreads','MixedChunk - PThreads']
    collected_data = {file: [] for file in files}   
